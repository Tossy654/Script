...
/*
	[Script]
	AQI-US = type=http-response, pattern=https://weather-data.apple.com/v1/weather/[\w-]+/[0-9]+\.[0-9]+/[0-9]+\.[0-9]+\?include=, requires-body=true, script-path=https://github.com/Tossy654/SS-Rule-Snippet/blob/master/Scripts/Surge/iOS_Weather_AQI_Standard.js
